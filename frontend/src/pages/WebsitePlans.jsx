...
export default function WebsitePlansPage() {
  ...
  const fetchPlans = async () => {
    try {
      const res = await API.get("/admin/plan?platform=website");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        alert("Website plan updated successfully.");
      } else {
        await API.post("/admin/plan", payload);
        alert("Website plan created successfully.");
      }
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Delete this website plan?")) return;
  ...
  return (
    <div className="add-content-page">
      ...
      <div className="pg-header">
        <h1 className="pg-title">🌐 Website Subscription Plans</h1>
        <p className="pg-sub">Create and manage subscription plans exclusively for Website users</p>
      </div>

      {/* ================= FORM ================= */}
      <form onSubmit={handleSubmit}>
        <div className="form-card">
          <h3>{editId ? "Edit Website Plan" : "Create New Website Plan"}</h3>
          ...
          <div className="form-2col">
            <div className="form-row">
              ...
              <input
                ...
                name="name"
                placeholder="e.g. Web Premium, Web Gold"
                value={form.name}
                onChange={ch}
                required
              />
            ...
            <div className="form-row form-full">
              ...
              <input
                ...
                name="features"
                placeholder="4K Ultra HD on Web, Ad-free, Multiple screens"
                value={form.features}
                onChange={ch}
              />
            </div>
            ...
            >
              <span style={{ display: "flex", alignItems: "center", gap: 8, fontWeight: 500 }}>
                {form.isActive ? "✓ Active" : "✗ Inactive"} (Visible on Website)
              </span>
              <input
                type="checkbox"
                name="isActive"
              ...
              {plans.length === 0 ? (
                <tr>
                  <td colSpan="7" style={{ textAlign: "center", padding: "24px" }}>
                    No website plans found. Create one above!
                  </td>
                </tr>
              ) : (
                plans.map((p) => (
                    ...
                    <td>
                      <button
                        ...
                        style={{
                          ...
                          transition: "all 0.2s",
                          background:
                            p.isActive !== false ? "rgba(16,185,129,0.12)" : "rgba(220,38,38,0.12)",
                          borderColor:
                            p.isActive !== false ? "rgba(16,185,129,0.4)" : "rgba(220,38,38,0.4)",
          ...
          <div className="modal-box modal-box-view" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body p-0">
              <div
                ...
                style={{ padding: 24, display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}
              >
                <div
                  className="p-detail-card"
                  style={{ background: "var(--bg-card-soft)", padding: "16px", borderRadius: "8px" }}
                >
                  <span
                ...
                >
                  ...
                  <span
                    className="p-detail-value"
                    style={{ fontWeight: 600, fontSize: "1.1rem", textTransform: "capitalize" }}
                  >
                ...
                >
                  <span
                    className="p-detail-label"
                    style={{ display: "block", fontSize: "0.8rem", color: "var(--text-muted)", marginBottom: "8px" }}
                  >
                    Features
                  </span>
